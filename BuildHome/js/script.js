...
var skillsMap = _.map(data, 'skills');
//console.log('map skills', skillsMap);

var skillsFlatten = _.flattenDeep(skillsMap);
//console.log('flatten skills', skillsFlatten);

var skillsUniq = _.uniq(skillsFlatten);
//console.log('uniq skills', skillsUniq);

var skillsSort = skillsUniq.sort();
console.log('sorted uniq skills', skillsSort);

var friendsName = [];
for (var i = 0; i < data.length; i++) {
	friendsName.push(_.pick(data[i], ['name', 'friends']));
	friendsName[i].number = friendsName[i].friends.length;
}
//console.log('[{"friends", "name", "number"}] ', friendsName);

var friendsNameSort = _.orderBy(friendsName, ['number', 'name'], ['desc', 'asc']);
//console.log('sort friends', friendsNameSort);

var nameSort = _.map(friendsNameSort, 'name');
console.log('names sorted by friends', nameSort);

var friendsMap = _.map(data, 'friends');
//console.log('map friends ', friendsMap);

var friendsFlatten = _.flattenDeep(friendsMap);
//console.log('flatten friends ', friendsFlatten);

var namesMap = _.map(friendsFlatten, 'name');
//console.log('map friends names ', namesMap);

var namesUniq = _.uniq(namesMap);
console.log('uniq friends names ', namesUniq);
